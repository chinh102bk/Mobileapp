    ...
    save.addEventListener("click",
        function (e) {
            ...
            if (key == "" || value == "") {
                ...
                let w_confirm = window.confirm("このページの内容 LocalStorageに" + key + " " + value + "を保存（save)しますか？");
                if (w_confirm) {
...
function allClearLocalStorage() {
    ...
    allClear.addEventListener("click",
        function (e) {
            e.preventDefault();
            let w_confirm = confirm("LocalStorageからのデータをすべて削除 ( all clear) します。よろしいでしょうか。");
...
function viewStorage() {
    ...
    for (let i = 0; i < localStorage.length; i++) {
        ...
        td1.innerHTML = "<input name='chkbox1' type='radio'>";
        td2.innerHTML = w_key;
