...
let startTime; // Startボタンクリック時の時刻 9 let startTime; // Startボタンクリック時の時刻
let timeoutid; // ID 10 let timeoutid; // ID
let stopTime = 0;
let soundEndflag = "0";
...
stop.addEventListener("click",
  function () {
    ...
    if (stopTime >= 10000 && stopTime < 11000) {
      ...
      body.style.backgroundImage = "url('img/fireworks.gif')"; // 花火
